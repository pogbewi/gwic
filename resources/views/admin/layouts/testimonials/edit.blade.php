    ...
    <div class="container-fluid">
        ...
        <section>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-danger alert-dismissible text-white">
                                    ...
                                    <p class="card-text">Edit Testimonials Here</p>
                                </div>
                                <hr class="my-2">
                            </div>
                        </div>
            ...
            {!! Form::model($testimonial, [
                              'method' => 'PATCH',
                              'route' => ['testimonials.update', $testimonial->slug],
                              'role' => 'form'
                          ]) !!}
            <div class="row">
                    <div class="col-md-8 text-center mb-5 wow fadeInLeft">
                        <div class="card card-cascade">
                            ...
                            <div class="card-body card-body-cascade">
                                {{ Form::hidden('slug', $testimonial->slug ,['class'=>'form-control', 'id'=>'slug', 'placeholder'=>'Slug']) }}
                        ...
                        <div class="card card-cascade">
                            ...
                            <div class="card-body card-body-cascade">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::text('tag_names', $testimonial->tag_names, ['class'=>'form-control', 'id'=>'tag_names','data-role'=>"tagsinput", 'placeholder'=>'Tag Names']) }}
                                </div>
                            ...
                            <!-- Default checked -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="allow_comments" id="allow_comments" {{ $testimonial->allow_comments ? 'checked ' : 'unchecked '}}>
                            ...
                            <div class="card card-body-cascade">
                                ...
                                <div class="card-body card-body-cascade">
                                    <div class="inform" style="padding: 7px"><img src="/storage/uploads/testimonies/images/thumbnails/{{ $testimonial->photo }}" width="100%"></div>
                                    {{ Form::hidden('photo', old('photo'),['id'=>'photo']) }}
                                    {{ Form::file('image',['id'=>'image', 'data-url'=>route('admin.testimonials.upload')]) }}
                                </div>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-danger btn-rounded pull-right mt-5 mr-5">
                            <i class="fa fa-plus-circle"></i> Update Testimony
                        </button>
                    </div>
                </div>
            {!! Form::close() !!}
