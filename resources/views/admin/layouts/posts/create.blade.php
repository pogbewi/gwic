                    ...
                    <div class="card card-cascade">
                        ...
                        <div class="card-body card-body-cascade">
                            <div class="form-group">
                                ...
                                <select class="post-select form-control" name="category_id" id="category_id">
