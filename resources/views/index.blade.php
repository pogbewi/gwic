            ...
            <div class="container">
                ...
                <section id="blog" class="text-center my-5">
                    ...
                    <div class="row">
                        ...
                        <!-- Grid column -->
                        <div class="col-lg-4 col-md-6 mb-md-0 mb-4 blog">
                        ...
                        <!-- Grid column -->
                        <div class="col-lg-4 col-md-6 mb-0 blog">
                            ...
                            <!-- Category -->
                            <a href="#!" class="blue-text"><h6 class="font-weight-bold mb-3"><i class="fa fa-fire pr-2"></i>Culture</h6></a>
                            <!-- Post title -->
                            <h4 class="font-weight-bold mb-3"><strong>Title of the news</strong></h4>
                            <!-- Post data -->
